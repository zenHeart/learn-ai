...
> 📌 **本节内容较深，非必需**
> - 如果你想快速上手，跳到第 3 章「如何使用」
> - 如果你想深入理解 LLM 原理，继续往下看
...
4. **[Token](https://cursor.com/learn/tokens-pricing#understanding-tokens)** 大模型处理信息的最小文本单元 <VibeExample id="2.1" />
...
2. **[Embeddings(嵌入)](https://developers.google.com/mace-learning/crash-course/embeddings/embedding-space?hl=zh-cn)** 将文本/图片/音频/视频转换为向量数据的技术 <VibeExample id="2.2" />
...
1. **[Transformer 架构](https://arxiv.org/abs/1706.03762)** 通过**注意力机制**让每个词"关注"其他词，**基于概率预测生成下一个token**（而非真正"理解"语义），[交互示意图](https://bbycroft.net/llm) <VibeExample id="2.3" />
