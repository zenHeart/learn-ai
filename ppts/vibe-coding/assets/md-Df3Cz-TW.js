...
`),k((d(),r("div",null,[...a[2]||(a[2]=[t("ol",{start:"3"},[t("li",null,[t("strong",null,[t("a",{href:"https://arxiv.org/abs/1706.03762",target:"_blank"},"Transformer 架构")]),n(" 通过"),t("strong",null,"注意力机制"),n('让每个词"关注"其他词，从而理解语义，'),t("a",{href:"https://bbycroft.net/llm",target:"_blank"},"交互示意图"),t("ul",null,[t("li",null,[t("strong",null,"Positional Encoding"),n(' 给每个词贴上"座位号"，让模型知道词的顺序')]),t("li",null,[t("strong",null,"Encoder"),n(" 「读题」— 双向阅读全文，理解输入的完整含义")]),t("li",null,[t("strong",null,"Decoder"),n(" 「写答案」— 逐字生成输出（GPT/Claude 只用这部分）")])])])],-1)])])),[[c,3]]),L(p,{activeCount:y(e)},null,8,["activeCount"]),a[4]||(a[4]=t("p",null,"Demo: npm run demo:2.3",-1))]),_:1},16)}}};export{Y as default};
