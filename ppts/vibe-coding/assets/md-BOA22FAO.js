...
`),k((r(),a("div",null,[t("ol",K,[t("li",null,[d[2]||(d[2]=t("strong",null,[t("a",{href:"https://arxiv.org/abs/1706.03762",target:"_blank"},"Transformer 架构")],-1)),d[3]||(d[3]=l(" 通过",-1)),d[4]||(d[4]=t("strong",null,"注意力机制",-1)),d[5]||(d[5]=l('让每个词"关注"其他词，从而理解语义，',-1)),d[6]||(d[6]=t("a",{href:"https://bbycroft.net/llm",target:"_blank"},"交互示意图",-1)),d[7]||(d[7]=l()),m(u,{id:"2.3"}),d[8]||(d[8]=t("ul",null,[t("li",null,[t("strong",null,"Positional Encoding"),l(' 给每个词贴上"座位号"，让模型知道词的顺序')]),t("li",null,[t("strong",null,"Encoder"),l(" 「读题」— 双向阅读全文，理解输入的完整含义")]),t("li",null,[t("strong",null,"Decoder"),l(" 「写答案」— 逐字生成输出（GPT/Claude 只用这部分）")])],-1))])])])),[[c,3]]),m(g,{activeCount:y(e)},null,8,["activeCount"])]),_:1},16)}}};export{W as default};
