...
`),k((r(),a("div",null,[t("ol",K,[t("li",null,[d[2]||(d[2]=t("strong",null,[t("a",{href:"https://arxiv.org/abs/1706.03762",target:"_blank"},"Transformer 架构")],-1)),d[3]||(d[3]=f(" 通过",-1)),d[4]||(d[4]=t("strong",null,"注意力机制",-1)),d[5]||(d[5]=f('让每个词"关注"其他词，',-1)),d[6]||(d[6]=t("strong",null,"基于概率预测生成下一个token",-1)),d[7]||(d[7]=f('（而非真正"理解"语义），',-1)),d[8]||(d[8]=t("a",{href:"https://bbycroft.net/llm",target:"_blank"},"交互示意图",-1)),d[9]||(d[9]=f()),m(u,{id:"2.3"})])])])),[[c,3]]),m(b,{activeCount:y(e)},null,8,["activeCount"])]),_:1},16)}}};export{j as default};
