...
```json
{
  "hooks": {
    "PostToolUse": [{
      ...
      "hooks": [{
        "type": "command",
        "command": "claude --permission-mode auto-edit -p 'review this file' \"$CLAUDE_TOOL_INPUT_FILE_PATH\"",
        "async": true
      }]
    }]
  }
...
- [claude-code-setup](https://github.com/vercel-labs/claude-code-setup) — Anthropic-endorsed auto-config plugin, one-click install community best practices (Hooks + MCP + Skills) <!-- TODO: confirm repository URL; original returns 404 on 2026-08-17, may have been renamed or removed -->
...
> - [claude-code-setup](https://github.com/vercel-labs/claude-code-setup) — Anthropic-endorsed auto-config plugin, one-click install Hooks/MCP/Skills best practices <!-- TODO: confirm repository URL; original returns 404 on 2026-08-17, may have been renamed or removed -->
