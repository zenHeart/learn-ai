...
3. **Prompt Engineering PPT** (`/ppts/prompt-context`)
...
- Prompt PPT: `https://blog.zenheart.site/learn-ai/ppts/prompt-context/`
...
- Prompt: `ppts/prompt-context/slides.md`
...
- Prompt PPT: `slidev build --base /learn-ai/ppts/prompt-context/`
...
**例外**: PPT 子目录 (`ppts/vibe-coding/`, `ppts/prompt-context/` 等) 直接使用 `npm`，因为它们是独立的 Slidev 项目。这是设计如此，是构建流程必需的。
